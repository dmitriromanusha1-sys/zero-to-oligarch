...
const ZONE_CONDITIONS: Array = [
	{"title_req":  2, "edu_req": 1, "desc": "Нищий (5 000 ₽) + Чтение"},
	{"title_req":  4, "edu_req": 3, "desc": "Бедный (40 000 ₽) + 9 классов"},
	{"title_req":  6, "edu_req": 4, "desc": "Простой (250 000 ₽) + ПТУ"},
	{"title_req":  8, "edu_req": 5, "desc": "Специалист (1 500 000 ₽) + Колледж"},
	{"title_req": 10, "edu_req": 6, "desc": "Богатый (10 000 000 ₽) + Бакалавр"},
	{"title_req": 12, "edu_req": 7, "desc": "Миллионер (60 000 000 ₽) + Магистр"},
	{"title_req": 14, "edu_req": 8, "desc": "Мультимиллионер (600 000 000 ₽) + Аспирант"},
	{"title_req": 15, "edu_req": 9, "desc": "Магнат (2 500 000 000 ₽) + Доктор наук"},
	{},  # Зона 8 — финальная
]
