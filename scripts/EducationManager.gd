...
const LEVELS: Array = [
	{"name": "Без образования",  "icon": "🚫", "price": 0,          "desc": "Только подённая работа: бутылки, подметание дворов"},
	{"name": "Чтение",           "icon": "📖", "price": 150,        "desc": "Простые работы: грузчик, продавец, разнорабочий"},
