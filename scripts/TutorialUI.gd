...
func _define_steps() -> void:
	_steps = [
		...
		},
		{
			...
			"text": "Стоя рядом со зданием, нажми E, чтобы открыть его. На работе выбираешь длину смены (4–12 ч): чем дольше смена, тем больше денег, но тем сильнее тратятся энергия и здоровье. Доход = ставка × часы × результат мини-игры.",
			"mode": "info",
			"target": "job",
		},
		{
			"title": "Выживание",
			"text": "Следи за шкалами вверху: 🍖 сытость, 💧 вода, ⚡ энергия, ❤ здоровье. Если сытость или вода падают до нуля — теряешь здоровье. Покупай еду и напитки в магазинах.",
			"mode": "info",
			"target": "bars",
		},
		{
			"title": "Сон и отдых",
			"text": "Энергию восстанавливает только сон. Нажми эту кнопку и выбери, сколько часов спать. Качество сна зависит от жилья — чем лучше дом, тем больше энергии и здоровья за час.",
			"mode": "info",
			"target": "sleep",
		},
		{
			"title": "Образование",
			"text": "🎓 В школах, колледжах и университетах можно получить образование (со сдачей экзамена). Чем выше уровень — тем более доходные работы открываются. Без образования доступны только самые низкие подработки.",
			"mode": "info",
			"target": "none",
		},
		{
			"title": "Экономика и деньги",
			"text": "💸 Цены растут со временем (инфляция) и зависят от района — в богатых кварталах жить дороже, но и платят там больше. Есть налоги с дохода и экономические циклы (бум/спад). Кнопка 📊 в нижней панели — экран «Финансы»: твой капитал, доходы, расходы и состояние экономики страны.",
			"mode": "info",
			"target": "none",
		},
		{
